...
public class LoginMapper {
    ...
    public User Login(User user) {
        //sql inject
        String sql = "SELECT * FROM public.user where user_name='"+user.getUserName()+"' and user_pwd='"+user.getUserPwd()+"' and public.user.delete=0";
    ...
    public Integer isRepeatUserName(User user) {
        //sql inject
        String sql = "SELECT * FROM public.user where user_name='"+user.getUserName()+"' and public.user.delete=0";
        try(Connection connection = jdbcUtils.getConnection();
            PreparedStatement statement = connection.prepareStatement(sql)){
